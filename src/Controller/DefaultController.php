...
class DefaultController extends AbstractController
{
    public function indexAction(Request $request, TechnoRepository $technoRepository, SkillRepository $skillRepository)
    {
        ...
        return $this->render('home.html.twig', ["technos" => $technos, "technoForm"=>$technoForm->createView() , "skillForm"=>$skillForm->createView(),
        "categoryForm"=>$categoryForm->createView() , "projectForm"=>$projectForm->createView()]);
    }
}